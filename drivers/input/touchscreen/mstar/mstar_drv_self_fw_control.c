        ...
        if (bIsCorrectFormat) 
        {
			...
			switch (nWakeupMode)
            {
                case 0x58:
                    ...
                    pr_debug("Light up screen by DOUBLE_CLICK gesture wakeup.\n");
		    pr_debug("nWakeupMode = 0x%x\n", nWakeupMode);
                    input_report_key(g_InputDevice, KEY_POWER, 1);
                    input_sync(g_InputDevice);
                    input_report_key(g_InputDevice, KEY_POWER, 0);
                    input_sync(g_InputDevice);
                ...
                case 0x60:
                    ...
                    pr_debug("Light up screen by UP_DIRECT gesture wakeup.\n");
		    pr_debug("nWakeupMode = 0x%x\n", nWakeupMode);
                ...
                case 0x61:
                    ...
                    pr_debug("Light up screen by DOWN_DIRECT gesture wakeup.\n");
		    pr_debug("nWakeupMode = 0x%x\n", nWakeupMode);
                ...
                case 0x62:
                    ...
                    pr_debug("Light up screen by LEFT_DIRECT gesture wakeup.\n");
	       	    pr_debug("nWakeupMode = 0x%x\n", nWakeupMode);
                ...
                case 0x63:
                    ...
                    pr_debug("Light up screen by RIGHT_DIRECT gesture wakeup.\n");
		    pr_debug("nWakeupMode = 0x%x\n", nWakeupMode);
                ...
                case 0x64:
                    ...
                    pr_debug("Light up screen by m_CHARACTER gesture wakeup.\n");
		    pr_debug("nWakeupMode = 0x%x\n", nWakeupMode);
                ...
                case 0x65:
                    ...
                    pr_debug("Light up screen by W_CHARACTER gesture wakeup.\n");
		    pr_debug("nWakeupMode = 0x%x\n", nWakeupMode);
                ...
                case 0x66:
                    ...
                    pr_debug("Light up screen by C_CHARACTER gesture wakeup.\n");
		    pr_debug("nWakeupMode = 0x%x\n", nWakeupMode);
                ...
                case 0x67:
                    ...
                    pr_debug("Light up screen by e_CHARACTER gesture wakeup.\n");
		    pr_debug("nWakeupMode = 0x%x\n", nWakeupMode);
                ...
                case 0x68:
                    ...
                    pr_debug("Light up screen by V_CHARACTER gesture wakeup.\n");
		    pr_debug("nWakeupMode = 0x%x\n", nWakeupMode);
                ...
                case 0x69:
                    ...
                    pr_debug("Light up screen by O_CHARACTER gesture wakeup.\n");
		    pr_debug("nWakeupMode = 0x%x\n", nWakeupMode);
                ...
                case 0x6A:
                    ...
                    pr_debug("Light up screen by S_CHARACTER gesture wakeup.\n");
		    pr_debug("nWakeupMode = 0x%x\n", nWakeupMode);
                ...
                case 0x6B:
                    ...
                    pr_debug("Light up screen by Z_CHARACTER gesture wakeup.\n");
		    pr_debug("nWakeupMode = 0x%x\n", nWakeupMode);
                ...
                case 0x6C:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE1_FLAG gesture wakeup.\n");
                ...
                case 0x6D:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE2_FLAG gesture wakeup.\n");
                ...
                case 0x6E:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE3_FLAG gesture wakeup.\n");
                ...
                case 0x6F:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE4_FLAG gesture wakeup.\n");
                ...
                case 0x70:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE5_FLAG gesture wakeup.\n");
                ...
                case 0x71:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE6_FLAG gesture wakeup.\n");
                ...
                case 0x72:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE7_FLAG gesture wakeup.\n");
                ...
                case 0x73:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE8_FLAG gesture wakeup.\n");
                ...
                case 0x74:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE9_FLAG gesture wakeup.\n");
                ...
                case 0x75:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE10_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER10, 0);
                ...
                case 0x76:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE11_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER11, 0);
                ...
                case 0x77:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE12_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER12, 0);
                ...
                case 0x78:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE13_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER13, 0);
                ...
                case 0x79:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE14_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER14, 0);
                ...
                case 0x7A:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE15_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER15, 0);
                ...
                case 0x7B:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE16_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER16, 0);
                ...
                case 0x7C:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE17_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER17, 0);
                ...
                case 0x7D:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE18_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER18, 0);
                ...
                case 0x7E:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE19_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER19, 0);
                ...
                case 0x7F:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE20_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER20, 0);
                ...
                case 0x80:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE21_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER21, 0);
                ...
                case 0x81:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE22_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER22, 0);
                ...
                case 0x82:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE23_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER23, 0);
                ...
                case 0x83:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE24_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER24, 0);
                ...
                case 0x84:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE25_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER25, 0);
                ...
                case 0x85:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE26_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER26, 0);
                ...
                case 0x86:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE27_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER27, 0);
                ...
                case 0x87:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE28_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER28, 0);
                ...
                case 0x88:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE29_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER29, 0);
                ...
                case 0x89:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE30_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER30, 0);
                ...
                case 0x8A:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE31_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER31, 0);
                ...
                case 0x8B:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE32_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER32, 0);
                ...
                case 0x8C:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE33_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER33, 0);
                ...
                case 0x8D:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE34_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER34, 0);
                ...
                case 0x8E:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE35_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER35, 0);
                ...
                case 0x8F:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE36_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER36, 0);
                ...
                case 0x90:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE37_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER37, 0);
                ...
                case 0x91:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE38_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER38, 0);
                ...
                case 0x92:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE39_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER39, 0);
                ...
                case 0x93:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE40_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER40, 0);
                ...
                case 0x94:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE41_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER41, 0);
                ...
                case 0x95:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE42_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER42, 0);
                ...
                case 0x96:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE43_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER43, 0);
                ...
                case 0x97:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE44_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER44, 0);
                ...
                case 0x98:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE45_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER45, 0);
                ...
                case 0x99:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE46_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER46, 0);
                ...
                case 0x9A:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE47_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER47, 0);
                ...
                case 0x9B:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE48_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER48, 0);
                ...
                case 0x9C:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE49_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER49, 0);
                ...
                case 0x9D:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE50_FLAG gesture wakeup.\n");
...
//                    input_report_key(g_InputDevice, RESERVER50, 0);
                ...
                case 0x9E:
                    ...
                    pr_debug("Light up screen by GESTURE_WAKEUP_MODE_RESERVE51_FLAG gesture wakeup.\n");
